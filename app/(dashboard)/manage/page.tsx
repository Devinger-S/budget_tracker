  ...
  return (
    <>
      <div className="border-b bg-card">
        <div className="container flex flex-wrap items-center justify-start gap-6 py-8">
          <div>
...
function CategoryList({ type }: { type: TransactionType }) {
  const categoriesQuery = useQuery({
    ...
    queryFn: () =>
      fetch(`/api/categories?tpe=${type}`).then((res) => res.json()),
  });
            ...
            <CardTitle className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">Sorted by name</div>
                </div>
              </div>
              <CreateCategoryDialog
                ...
                trigger={
                  <Button className="gap-2 text-sm">
                    <PlusSquare className="h-4 w-4" /> Create category
                  </Button>
                }
              />
            </CardTitle>
